  ...
  return (
    <header className={styles.header}>
      <div className={styles.inner}>
        <a className={styles.brand} href="#home" aria-label="BGrafX home">
          <BrandMark />
        </a>
        ...
        <a className={styles.quote} href="https://wa.me/27621596082" target="_blank" rel="noopener noreferrer">
      ...
      <nav id="mobile-navigation" className={`${styles.mobileNav} ${isOpen ? styles.mobileNavOpen : ""}`} aria-label="Mobile navigation">
        ...
        <a className={styles.mobileQuote} href="https://wa.me/27621596082" target="_blank" rel="noopener noreferrer" onClick={() => setIsOpen(false)}>
