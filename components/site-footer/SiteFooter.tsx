...
export function SiteFooter() {
  return (
    <footer className={styles.footer}>
      ...
      <nav aria-label="Footer navigation"><span>Explore</span><Link href="/">Home</Link><Link href="/work/kerfsuite">KerfSuite case study</Link><Link href="/work/mkvoodoo">MKVoodoo product</Link><Link href="/work">Website portfolio</Link><Link href="/cladding">Cladding career</Link><Link href="/services">Services</Link><Link href="/tools/fontforge">FontForge converter</Link><Link href="/#pricing">Pricing</Link><Link href="/#contact">Contact</Link></nav>
