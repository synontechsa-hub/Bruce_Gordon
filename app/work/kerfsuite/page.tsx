    ...
    <main id="main-content">
      <section className={styles.hero} aria-labelledby="case-study-title">
        ...
        <div className={styles.heroCopy}>
          ...
          <p>KerfSuite is a growing ecosystem of connected tools for CNC and fabrication workflows. The work brings together brand, product, interface and web development with first-hand production experience.</p>
