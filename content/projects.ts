...
export const websiteProjects: WebsiteProject[] = [
  ...
  { slug: "nexus-ai", title: "Nexus AI", category: "SaaS / Product web", summary: "A multi-page AI product website exploring conversion structure, documentation, pricing and a scalable interface language.", status: "Self-initiated concept", image: "/media/work/nexus-ai.webp", imageAlt: "NexusAI enterprise intelligence homepage concept with analytics dashboard interface", legacyPath: "/NexusAI-website/index.html" },
