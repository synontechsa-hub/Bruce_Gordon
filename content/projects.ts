...
export const websiteProjects: WebsiteProject[] = [
  { slug: "forma-studio", title: "Forma Studio", category: "Architecture / Editorial web", summary: "A restrained, image-led architecture studio concept built around strong hierarchy, generous space and project storytelling.", status: "Self-initiated concept", image: "/media/forma.jpg", imageAlt: "Forma Studio architecture website concept" },
  { slug: "solstice-goods", title: "Solstice Goods", category: "E-commerce / UX", summary: "A warm lifestyle-commerce concept exploring product discovery, brand atmosphere and a calm responsive shopping journey.", status: "Self-initiated concept", image: "/media/solstice.jpg", imageAlt: "Solstice Goods e-commerce website concept" },
  { slug: "vela-wealth", title: "Vela Wealth", category: "Fintech / Interface", summary: "A financial-services interface study balancing data clarity, trust and a composed premium visual system.", status: "Self-initiated concept", image: "/media/vela.jpg", imageAlt: "Vela Wealth financial website and interface concept" },
  { slug: "nexus-ai", title: "Nexus AI", category: "SaaS / Product web", summary: "A multi-page AI product website exploring conversion structure, documentation, pricing and a scalable interface language.", status: "Self-initiated concept", image: "/media/work/nexus-ai.webp", imageAlt: "NexusAI enterprise intelligence homepage concept with analytics dashboard interface" },
  ...
  { slug: "origin-root", title: "Origin Root", category: "Specialty coffee / Brand web", summary: "A coffee brand and website exploration connecting provenance, tactile materials and a distinctive retail personality.", status: "Self-initiated concept", image: "/media/work/origin-root.png", imageAlt: "Origin Root specialty coffee identity", imageFit: "contain" },
